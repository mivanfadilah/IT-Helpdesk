...
class InventoryController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				inventory.jenis LIKE ? OR 
				inventory.merk LIKE ? OR 
				inventory.tipe LIKE ? OR 
				inventory.serial_number LIKE ? OR 
				inventory.kondisi LIKE ? OR 
				inventory.stok LIKE ? OR 
				inventory.lemari LIKE ? OR 
				inventory.keterangnan LIKE ?
			)";
			$search_params = array(
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("jenis","merk","tipe","serial_number","kondisi","stok","lemari","keterangnan");
			...
			$this->sanitize_array = array(
				...
				'lemari' => 'sanitize_string',
				'keterangnan' => 'sanitize_string',
			);
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","jenis","merk","tipe","serial_number","kondisi","stok","lemari","keterangnan");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
			);
