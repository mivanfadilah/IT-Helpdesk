                                    ...
                                    <table class="table  table-striped table-sm text-center table-bordered">
                                        <thead class="table-header bg-primary text-white">
                                            <tr>
                                                ...
                                                <th  class="td-lemari"> Lemari</th>
                                                <th  class="td-keterangnan"> Keterangnan</th>
                                                <th class="td-btn"></th>
                                            </tr>
                                        </thead>
                                        <?php
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <td class="td-jenis"> <?php echo $data['jenis']; ?></td>
                                                <td class="td-merk"> <?php echo $data['merk']; ?></td>
                                                <td class="td-tipe"> <?php echo $data['tipe']; ?></td>
                                                <td class="td-serial_number"> <?php echo $data['serial_number']; ?></td>
                                                <td class="td-kondisi"> <?php echo $data['kondisi']; ?></td>
                                                <td class="td-stok"> <?php echo $data['stok']; ?></td>
                                                <td class="td-lemari"><a href="<?php print_link("inventory/index/lemari/$data[lemari]") ?>"><?php echo $data['lemari']; ?></a></td>
                                                <td class="td-keterangnan"> <?php echo $data['keterangnan']; ?></td>
                                                <th class="td-btn">
