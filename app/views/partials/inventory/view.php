                            ...
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    <tr  class="td-jenis">
                                        ...
                                        <td class="value"> <?php echo $data['jenis']; ?></td>
                                    </tr>
                                    <tr  class="td-merk">
                                        <th class="title"> Merk: </th>
                                        <td class="value"> <?php echo $data['merk']; ?></td>
                                    </tr>
                                    <tr  class="td-tipe">
                                    ...
                                    <tr  class="td-kondisi">
                                        ...
                                        <td class="value"> <?php echo $data['kondisi']; ?></td>
                                    </tr>
                                    <tr  class="td-stok">
                                    ...
                                    <tr  class="td-lemari">
                                        <th class="title"> Lemari: </th>
                                        <td class="value"> <?php echo $data['lemari']; ?></td>
                                    </tr>
                                    <tr  class="td-keterangnan">
                                        <th class="title"> Keterangnan: </th>
                                        <td class="value"> <?php echo $data['keterangnan']; ?></td>
                                    </tr>
                                </tbody>
                                <!-- Table Body End -->
                            </table>
